...
def blocked(x1, y1, x2, y2, board):
    ...
    for wall in board.walls:
        if wall.orientation == "horizontal":
            if y1 < y2:
                if wall.top_l.y == y1 and (
                    wall.top_l.x == x1 or (wall.top_l.x + 1) == x1
                ):
                    return True
            if y1 > y2:
                if wall.top_l.y == y2 and (
                    wall.top_l.x == x1 or (wall.top_l.x + 1) == x1
                ):
                    return True
        if wall.orientation == "vertical":
            if x1 < x2:
                if wall.top_l.x == x1 and (
                    wall.top_l.y == y1 or (wall.top_l.y + 1) == y1
                ):
                    return True
            if x1 > x2:
                if wall.top_l.x == x2 and (
                    wall.top_l.y == y2 or (wall.top_l.y + 1) == y2
                ):
                    return True
    return False
